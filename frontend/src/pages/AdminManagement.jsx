...
export default function AdminManagement() {
  ...
  const updateHackathonStatus = async (hackathonId, newStatus) => {
    try {
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {hackathon.registrationRequired && (
                          <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs">
                            Registration Required
                          </span>
                        )}
                        {hackathon.manualApproval && (
                          <span className="px-2 py-1 bg-orange-100 text-orange-800 rounded text-xs">
                            Manual Approval
                          </span>
                        )}
                        {hackathon.allowTeamFormation && (
                          <span className="px-2 py-1 bg-green-100 text-green-800 rounded text-xs">
                            Team Formation Allowed
                          </span>
                        )}
                        {hackathon.allowLateSubmissions && (
                          <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded text-xs">
                            Late Submissions
                          </span>
                        )}
                        {hackathon.publicResults && (
