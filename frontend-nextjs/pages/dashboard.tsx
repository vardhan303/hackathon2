        ...
        <div className="max-w-7xl mx-auto">
          ...
          {user?.role === "user" && (
            <div className="card p-6 mb-8 animate-slide-up">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Organizer Actions</h2>
              </div>
          ...
          <div className="card p-6 animate-slide-up">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">All Hackathons ({hackathons.length})</h2>
            </div>
