...
export default function AdminPanel() {
  const [hackathonRequests, setHackathonRequests] = useState<Request[]>([]);
  ...
  const approveHackathonRequest = async (id: string) => {
    try {
  ...
  const rejectHackathonRequest = async (id: string) => {
    try {
  ...
  const approveJudgeRequest = async (id: string) => {
    try {
  ...
  const rejectJudgeRequest = async (id: string) => {
    try {
